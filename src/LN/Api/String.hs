...
getOrganization' :: Text -> ApiEff (Either (ApiError ApplicationError) OrganizationResponse)
getOrganization' organization_name = handleError <$> getAt ([] :: [(Text, Text)]) ["organization", organization_name]

getOrganizationPack :: forall qp. QueryParam qp => [qp] -> Text -> ApiEff (Either (ApiError ApplicationError) OrganizationPackResponse)
getOrganizationPack params organization_name = handleError <$> getAt params ["organization_pack", organization_name]

getOrganizationPack' :: Text -> ApiEff (Either (ApiError ApplicationError) OrganizationPackResponse)
getOrganizationPack' organization_name = handleError <$> getAt ([] :: [(Text, Text)]) ["organization_pack", organization_name]

getTeam_ByOrganizationId :: forall qp. QueryParam qp => [qp] -> Text -> Int64 -> ApiEff (Either (ApiError ApplicationError) TeamResponse)
...
getTeam_ByOrganizationId' :: Text -> Int64 -> ApiEff (Either (ApiError ApplicationError) TeamResponse)
getTeam_ByOrganizationId' team_name _ByOrganizationId = handleError <$> getAt [ByOrganizationId _ByOrganizationId] ["team", team_name]

getTeamPack_ByOrganizationId :: forall qp. QueryParam qp => [qp] -> Text -> Int64 -> ApiEff (Either (ApiError ApplicationError) TeamPackResponse)
...
getTeamPack_ByOrganizationId' :: Text -> Int64 -> ApiEff (Either (ApiError ApplicationError) TeamPackResponse)
...
getGlobalGroup_ByOrganizationId :: forall qp. QueryParam qp => [qp] -> Text -> Int64 -> ApiEff (Either (ApiError ApplicationError) GlobalGroupResponse)
...
getGlobalGroup_ByOrganizationId' :: Text -> Int64 -> ApiEff (Either (ApiError ApplicationError) GlobalGroupResponse)
...
getGlobalGroupPack_ByOrganizationId :: forall qp. QueryParam qp => [qp] -> Text -> Int64 -> ApiEff (Either (ApiError ApplicationError) GlobalGroupPackResponse)
...
getGlobalGroupPack_ByOrganizationId' :: Text -> Int64 -> ApiEff (Either (ApiError ApplicationError) GlobalGroupPackResponse)
...
getGroup_ByOrganizationId :: forall qp. QueryParam qp => [qp] -> Text -> Int64 -> ApiEff (Either (ApiError ApplicationError) GroupResponse)
...
getGroup_ByOrganizationId' :: Text -> Int64 -> ApiEff (Either (ApiError ApplicationError) GroupResponse)
...
getGroupPack_ByOrganizationId :: forall qp. QueryParam qp => [qp] -> Text -> Int64 -> ApiEff (Either (ApiError ApplicationError) GroupPackResponse)
...
getGroupPack_ByOrganizationId' :: Text -> Int64 -> ApiEff (Either (ApiError ApplicationError) GroupPackResponse)
...
getForum_ByOrganizationId :: forall qp. QueryParam qp => [qp] -> Text -> Int64 -> ApiEff (Either (ApiError ApplicationError) ForumResponse)
...
getForum_ByOrganizationId' :: Text -> Int64 -> ApiEff (Either (ApiError ApplicationError) ForumResponse)
...
getForumPack_ByOrganizationId :: forall qp. QueryParam qp => [qp] -> Text -> Int64 -> ApiEff (Either (ApiError ApplicationError) ForumPackResponse)
...
getForumPack_ByOrganizationId' :: Text -> Int64 -> ApiEff (Either (ApiError ApplicationError) ForumPackResponse)
...
getBoard_ByForumId :: forall qp. QueryParam qp => [qp] -> Text -> Int64 -> ApiEff (Either (ApiError ApplicationError) BoardResponse)
...
getBoard_ByForumId' :: Text -> Int64 -> ApiEff (Either (ApiError ApplicationError) BoardResponse)
getBoard_ByForumId' board_name _ByForumId = handleError <$> getAt [ByForumId _ByForumId] ["board", board_name]

getBoardPack_ByForumId :: forall qp. QueryParam qp => [qp] -> Text -> Int64 -> ApiEff (Either (ApiError ApplicationError) BoardPackResponse)
...
getBoardPack_ByForumId' :: Text -> Int64 -> ApiEff (Either (ApiError ApplicationError) BoardPackResponse)
getBoardPack_ByForumId' board_name _ByForumId = handleError <$> getAt [ByForumId _ByForumId] ["board_pack", board_name]

getThread_ByBoardId :: forall qp. QueryParam qp => [qp] -> Text -> Int64 -> ApiEff (Either (ApiError ApplicationError) ThreadResponse)
...
getThread_ByBoardId' :: Text -> Int64 -> ApiEff (Either (ApiError ApplicationError) ThreadResponse)
getThread_ByBoardId' thread_name _ByBoardId = handleError <$> getAt [ByBoardId _ByBoardId] ["thread", thread_name]

getThreadPack_ByBoardId :: forall qp. QueryParam qp => [qp] -> Text -> Int64 -> ApiEff (Either (ApiError ApplicationError) ThreadPackResponse)
...
getThreadPack_ByBoardId' :: Text -> Int64 -> ApiEff (Either (ApiError ApplicationError) ThreadPackResponse)
