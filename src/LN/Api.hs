...
getApis :: forall qp. QueryParam qp => [qp] -> ApiEff (Either (ApiError ApplicationError) ApiResponses)
...
postApi :: forall qp. QueryParam qp => [qp] -> ApiRequest -> ApiEff (Either (ApiError ApplicationError) ApiResponse)
...
getApi :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) ApiResponse)
getApi params api_id = handleError <$> getAt params ["api", T.pack $ show api_id]

getApi' :: Int64 -> ApiEff (Either (ApiError ApplicationError) ApiResponse)
getApi' api_id = handleError <$> getAt ([] :: [(Text, Text)]) ["api", T.pack $ show api_id]

putApi :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiRequest -> ApiEff (Either (ApiError ApplicationError) ApiResponse)
putApi params api_id api_request = handleError <$> putAt params ["api", T.pack $ show api_id] api_request

putApi' :: Int64 -> ApiRequest -> ApiEff (Either (ApiError ApplicationError) ApiResponse)
putApi' api_id api_request = handleError <$> putAt ([] :: [(Text, Text)]) ["api", T.pack $ show api_id] api_request

deleteApi :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) ())
deleteApi params api_id = handleError <$> deleteAt params ["api", T.pack $ show api_id]

deleteApi' :: Int64 -> ApiEff (Either (ApiError ApplicationError) ())
deleteApi' api_id = handleError <$> deleteAt ([] :: [(Text, Text)]) ["api", T.pack $ show api_id]

getBoards :: forall qp. QueryParam qp => [qp] -> ApiEff (Either (ApiError ApplicationError) BoardResponses)
...
getBoards_ByBoardsIds :: forall qp. QueryParam qp => [qp] -> [Int64] -> ApiEff (Either (ApiError ApplicationError) BoardResponses)
getBoards_ByBoardsIds params _ByBoardsIds = handleError <$> getAt (map qp params <> map qp [ByBoardsIds _ByBoardsIds]) ["boards"]

getBoards_ByBoardsIds' :: [Int64] -> ApiEff (Either (ApiError ApplicationError) BoardResponses)
getBoards_ByBoardsIds' _ByBoardsIds = handleError <$> getAt [ByBoardsIds _ByBoardsIds] ["boards"]

getBoards_ByForumId :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) BoardResponses)
getBoards_ByForumId params _ByForumId = handleError <$> getAt (map qp params <> map qp [ByForumId _ByForumId]) ["boards"]

getBoards_ByForumId' :: Int64 -> ApiEff (Either (ApiError ApplicationError) BoardResponses)
getBoards_ByForumId' _ByForumId = handleError <$> getAt [ByForumId _ByForumId] ["boards"]

postBoard_ByForumId :: forall qp. QueryParam qp => [qp] -> Int64 -> BoardRequest -> ApiEff (Either (ApiError ApplicationError) BoardResponse)
...
postBoard_ByForumId' :: Int64 -> BoardRequest -> ApiEff (Either (ApiError ApplicationError) BoardResponse)
postBoard_ByForumId' _ByForumId board_request = handleError <$> postAt [ByForumId _ByForumId] ["board"] board_request

postBoard_ByBoardId :: forall qp. QueryParam qp => [qp] -> Int64 -> BoardRequest -> ApiEff (Either (ApiError ApplicationError) BoardResponse)
...
postBoard_ByBoardId' :: Int64 -> BoardRequest -> ApiEff (Either (ApiError ApplicationError) BoardResponse)
postBoard_ByBoardId' _ByBoardId board_request = handleError <$> postAt [ByBoardId _ByBoardId] ["board"] board_request

getBoard :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) BoardResponse)
getBoard params board_id = handleError <$> getAt params ["board", T.pack $ show board_id]

getBoard' :: Int64 -> ApiEff (Either (ApiError ApplicationError) BoardResponse)
getBoard' board_id = handleError <$> getAt ([] :: [(Text, Text)]) ["board", T.pack $ show board_id]

putBoard :: forall qp. QueryParam qp => [qp] -> Int64 -> BoardRequest -> ApiEff (Either (ApiError ApplicationError) BoardResponse)
putBoard params board_id board_request = handleError <$> putAt params ["board", T.pack $ show board_id] board_request

putBoard' :: Int64 -> BoardRequest -> ApiEff (Either (ApiError ApplicationError) BoardResponse)
putBoard' board_id board_request = handleError <$> putAt ([] :: [(Text, Text)]) ["board", T.pack $ show board_id] board_request

deleteBoard :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) ())
deleteBoard params board_id = handleError <$> deleteAt params ["board", T.pack $ show board_id]

deleteBoard' :: Int64 -> ApiEff (Either (ApiError ApplicationError) ())
deleteBoard' board_id = handleError <$> deleteAt ([] :: [(Text, Text)]) ["board", T.pack $ show board_id]

getBoardStats :: forall qp. QueryParam qp => [qp] -> ApiEff (Either (ApiError ApplicationError) BoardStatResponses)
...
getBoardStat :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) BoardStatResponse)
getBoardStat params board_id = handleError <$> getAt params ["board_stat", T.pack $ show board_id]

getBoardStat' :: Int64 -> ApiEff (Either (ApiError ApplicationError) BoardStatResponse)
getBoardStat' board_id = handleError <$> getAt ([] :: [(Text, Text)]) ["board_stat", T.pack $ show board_id]

getUsersCount :: forall qp. QueryParam qp => [qp] -> ApiEff (Either (ApiError ApplicationError) CountResponses)
...
getOrganizationsCount :: forall qp. QueryParam qp => [qp] -> ApiEff (Either (ApiError ApplicationError) CountResponses)
...
getTeamsCount :: forall qp. QueryParam qp => [qp] -> ApiEff (Either (ApiError ApplicationError) CountResponses)
...
getTeamsCount_ByOrganizationId :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) CountResponses)
...
getTeamsCount_ByOrganizationId' :: Int64 -> ApiEff (Either (ApiError ApplicationError) CountResponses)
getTeamsCount_ByOrganizationId' _ByOrganizationId = handleError <$> getAt [ByOrganizationId _ByOrganizationId] ["teams_count"]

getTeamMembersCount :: forall qp. QueryParam qp => [qp] -> ApiEff (Either (ApiError ApplicationError) CountResponses)
...
getTeamMembersCount_ByOrganizationId :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) CountResponses)
...
getTeamMembersCount_ByOrganizationId' :: Int64 -> ApiEff (Either (ApiError ApplicationError) CountResponses)
...
getTeamMembersCount_ByTeamId :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) CountResponses)
...
getTeamMembersCount_ByTeamId' :: Int64 -> ApiEff (Either (ApiError ApplicationError) CountResponses)
getTeamMembersCount_ByTeamId' _ByTeamId = handleError <$> getAt [ByTeamId _ByTeamId] ["team_members_count"]

getGlobalGroupsCount :: forall qp. QueryParam qp => [qp] -> ApiEff (Either (ApiError ApplicationError) CountResponses)
...
getGlobalGroupsCount_ByUserId :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) CountResponses)
...
getGlobalGroupsCount_ByUserId' :: Int64 -> ApiEff (Either (ApiError ApplicationError) CountResponses)
getGlobalGroupsCount_ByUserId' _ByUserId = handleError <$> getAt [ByUserId _ByUserId] ["global_groups_count"]

getGroupsCount :: forall qp. QueryParam qp => [qp] -> ApiEff (Either (ApiError ApplicationError) CountResponses)
...
getGroupsCount_ByOrganizationId :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) CountResponses)
...
getGroupsCount_ByOrganizationId' :: Int64 -> ApiEff (Either (ApiError ApplicationError) CountResponses)
getGroupsCount_ByOrganizationId' _ByOrganizationId = handleError <$> getAt [ByOrganizationId _ByOrganizationId] ["groups_count"]

getGroupMembersCount :: forall qp. QueryParam qp => [qp] -> ApiEff (Either (ApiError ApplicationError) CountResponses)
...
getGroupMembersCount_ByOrganizationId :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) CountResponses)
...
getGroupMembersCount_ByOrganizationId' :: Int64 -> ApiEff (Either (ApiError ApplicationError) CountResponses)
...
getGroupMembersCount_ByGroupId :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) CountResponses)
...
getGroupMembersCount_ByGroupId' :: Int64 -> ApiEff (Either (ApiError ApplicationError) CountResponses)
getGroupMembersCount_ByGroupId' _ByGroupId = handleError <$> getAt [ByGroupId _ByGroupId] ["group_members_count"]

getForumsCount :: forall qp. QueryParam qp => [qp] -> ApiEff (Either (ApiError ApplicationError) CountResponses)
...
getBoardsCount :: forall qp. QueryParam qp => [qp] -> ApiEff (Either (ApiError ApplicationError) CountResponses)
...
getThreadsCount :: forall qp. QueryParam qp => [qp] -> ApiEff (Either (ApiError ApplicationError) CountResponses)
...
getThreadsCount_ByBoardId :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) CountResponses)
getThreadsCount_ByBoardId params _ByBoardId = handleError <$> getAt (map qp params <> map qp [ByBoardId _ByBoardId]) ["threads_count"]

getThreadsCount_ByBoardId' :: Int64 -> ApiEff (Either (ApiError ApplicationError) CountResponses)
getThreadsCount_ByBoardId' _ByBoardId = handleError <$> getAt [ByBoardId _ByBoardId] ["threads_count"]

getThreadPostsCount :: forall qp. QueryParam qp => [qp] -> ApiEff (Either (ApiError ApplicationError) CountResponses)
...
getThreadPostsCount_ByThreadId :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) CountResponses)
...
getThreadPostsCount_ByThreadId' :: Int64 -> ApiEff (Either (ApiError ApplicationError) CountResponses)
getThreadPostsCount_ByThreadId' _ByThreadId = handleError <$> getAt [ByThreadId _ByThreadId] ["thread_posts_count"]

getResourcesCount :: forall qp. QueryParam qp => [qp] -> ApiEff (Either (ApiError ApplicationError) CountResponses)
...
getLeuronsCount :: forall qp. QueryParam qp => [qp] -> ApiEff (Either (ApiError ApplicationError) CountResponses)
...
getForums :: forall qp. QueryParam qp => [qp] -> ApiEff (Either (ApiError ApplicationError) ForumResponses)
...
getForums_ByOrganizationName :: forall qp. QueryParam qp => [qp] -> Text -> ApiEff (Either (ApiError ApplicationError) ForumResponses)
...
getForums_ByOrganizationName' :: Text -> ApiEff (Either (ApiError ApplicationError) ForumResponses)
getForums_ByOrganizationName' _ByOrganizationName = handleError <$> getAt [ByOrganizationName _ByOrganizationName] ["forums"]

getForums_ByForumsIds :: forall qp. QueryParam qp => [qp] -> [Int64] -> ApiEff (Either (ApiError ApplicationError) ForumResponses)
getForums_ByForumsIds params _ByForumsIds = handleError <$> getAt (map qp params <> map qp [ByForumsIds _ByForumsIds]) ["forums"]

getForums_ByForumsIds' :: [Int64] -> ApiEff (Either (ApiError ApplicationError) ForumResponses)
getForums_ByForumsIds' _ByForumsIds = handleError <$> getAt [ByForumsIds _ByForumsIds] ["forums"]

getForums_ByOrganizationId :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) ForumResponses)
...
getForums_ByOrganizationId' :: Int64 -> ApiEff (Either (ApiError ApplicationError) ForumResponses)
getForums_ByOrganizationId' _ByOrganizationId = handleError <$> getAt [ByOrganizationId _ByOrganizationId] ["forums"]

postForum_ByOrganizationId :: forall qp. QueryParam qp => [qp] -> Int64 -> ForumRequest -> ApiEff (Either (ApiError ApplicationError) ForumResponse)
...
postForum_ByOrganizationId' :: Int64 -> ForumRequest -> ApiEff (Either (ApiError ApplicationError) ForumResponse)
...
getForum :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) ForumResponse)
getForum params forum_id = handleError <$> getAt params ["forum", T.pack $ show forum_id]

getForum' :: Int64 -> ApiEff (Either (ApiError ApplicationError) ForumResponse)
getForum' forum_id = handleError <$> getAt ([] :: [(Text, Text)]) ["forum", T.pack $ show forum_id]

putForum :: forall qp. QueryParam qp => [qp] -> Int64 -> ForumRequest -> ApiEff (Either (ApiError ApplicationError) ForumResponse)
putForum params forum_id forum_request = handleError <$> putAt params ["forum", T.pack $ show forum_id] forum_request

putForum' :: Int64 -> ForumRequest -> ApiEff (Either (ApiError ApplicationError) ForumResponse)
putForum' forum_id forum_request = handleError <$> putAt ([] :: [(Text, Text)]) ["forum", T.pack $ show forum_id] forum_request

deleteForum :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) ())
deleteForum params forum_id = handleError <$> deleteAt params ["forum", T.pack $ show forum_id]

deleteForum' :: Int64 -> ApiEff (Either (ApiError ApplicationError) ())
deleteForum' forum_id = handleError <$> deleteAt ([] :: [(Text, Text)]) ["forum", T.pack $ show forum_id]

getForumStats :: forall qp. QueryParam qp => [qp] -> ApiEff (Either (ApiError ApplicationError) ForumStatResponses)
...
getForumStat :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) ForumStatResponse)
getForumStat params forum_id = handleError <$> getAt params ["forum_stat", T.pack $ show forum_id]

getForumStat' :: Int64 -> ApiEff (Either (ApiError ApplicationError) ForumStatResponse)
getForumStat' forum_id = handleError <$> getAt ([] :: [(Text, Text)]) ["forum_stat", T.pack $ show forum_id]

getGlobalGroups :: forall qp. QueryParam qp => [qp] -> ApiEff (Either (ApiError ApplicationError) GlobalGroupResponses)
...
getGlobalGroups_ByOrganizationId :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) GlobalGroupResponses)
...
getGlobalGroups_ByOrganizationId' :: Int64 -> ApiEff (Either (ApiError ApplicationError) GlobalGroupResponses)
getGlobalGroups_ByOrganizationId' _ByOrganizationId = handleError <$> getAt [ByOrganizationId _ByOrganizationId] ["global_groups"]

postGlobalGroup :: forall qp. QueryParam qp => [qp] -> GlobalGroupRequest -> ApiEff (Either (ApiError ApplicationError) GlobalGroupResponse)
...
getGlobalGroup :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) GlobalGroupResponse)
getGlobalGroup params global_group_id = handleError <$> getAt params ["global_group", T.pack $ show global_group_id]

getGlobalGroup' :: Int64 -> ApiEff (Either (ApiError ApplicationError) GlobalGroupResponse)
getGlobalGroup' global_group_id = handleError <$> getAt ([] :: [(Text, Text)]) ["global_group", T.pack $ show global_group_id]

putGlobalGroup :: forall qp. QueryParam qp => [qp] -> Int64 -> GlobalGroupRequest -> ApiEff (Either (ApiError ApplicationError) GlobalGroupResponse)
...
putGlobalGroup' :: Int64 -> GlobalGroupRequest -> ApiEff (Either (ApiError ApplicationError) GlobalGroupResponse)
...
deleteGlobalGroup :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) ())
deleteGlobalGroup params global_group_id = handleError <$> deleteAt params ["global_group", T.pack $ show global_group_id]

deleteGlobalGroup' :: Int64 -> ApiEff (Either (ApiError ApplicationError) ())
deleteGlobalGroup' global_group_id = handleError <$> deleteAt ([] :: [(Text, Text)]) ["global_group", T.pack $ show global_group_id]

getGroups :: forall qp. QueryParam qp => [qp] -> ApiEff (Either (ApiError ApplicationError) GroupResponses)
...
getGroups_ByOrganizationId :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) GroupResponses)
...
getGroups_ByOrganizationId' :: Int64 -> ApiEff (Either (ApiError ApplicationError) GroupResponses)
getGroups_ByOrganizationId' _ByOrganizationId = handleError <$> getAt [ByOrganizationId _ByOrganizationId] ["groups"]

postGroup_ByOrganizationId :: forall qp. QueryParam qp => [qp] -> Int64 -> GroupRequest -> ApiEff (Either (ApiError ApplicationError) GroupResponse)
...
postGroup_ByOrganizationId' :: Int64 -> GroupRequest -> ApiEff (Either (ApiError ApplicationError) GroupResponse)
...
getGroup :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) GroupResponse)
getGroup params group_id = handleError <$> getAt params ["group", T.pack $ show group_id]

getGroup' :: Int64 -> ApiEff (Either (ApiError ApplicationError) GroupResponse)
getGroup' group_id = handleError <$> getAt ([] :: [(Text, Text)]) ["group", T.pack $ show group_id]

putGroup :: forall qp. QueryParam qp => [qp] -> Int64 -> GroupRequest -> ApiEff (Either (ApiError ApplicationError) GroupResponse)
putGroup params group_id group_request = handleError <$> putAt params ["group", T.pack $ show group_id] group_request

putGroup' :: Int64 -> GroupRequest -> ApiEff (Either (ApiError ApplicationError) GroupResponse)
putGroup' group_id group_request = handleError <$> putAt ([] :: [(Text, Text)]) ["group", T.pack $ show group_id] group_request

deleteGroup :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) ())
deleteGroup params group_id = handleError <$> deleteAt params ["group", T.pack $ show group_id]

deleteGroup' :: Int64 -> ApiEff (Either (ApiError ApplicationError) ())
deleteGroup' group_id = handleError <$> deleteAt ([] :: [(Text, Text)]) ["group", T.pack $ show group_id]

getGroupMembers :: forall qp. QueryParam qp => [qp] -> ApiEff (Either (ApiError ApplicationError) GroupMemberResponses)
...
getGroupMembers_ByOrganizationId :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) GroupMemberResponses)
...
getGroupMembers_ByOrganizationId' :: Int64 -> ApiEff (Either (ApiError ApplicationError) GroupMemberResponses)
getGroupMembers_ByOrganizationId' _ByOrganizationId = handleError <$> getAt [ByOrganizationId _ByOrganizationId] ["group_members"]

getGroupMembers_ByGlobalGroupId :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) GroupMemberResponses)
...
getGroupMembers_ByGlobalGroupId' :: Int64 -> ApiEff (Either (ApiError ApplicationError) GroupMemberResponses)
getGroupMembers_ByGlobalGroupId' _ByGlobalGroupId = handleError <$> getAt [ByGlobalGroupId _ByGlobalGroupId] ["group_members"]

getGroupMembers_ByGroupId :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) GroupMemberResponses)
getGroupMembers_ByGroupId params _ByGroupId = handleError <$> getAt (map qp params <> map qp [ByGroupId _ByGroupId]) ["group_members"]

getGroupMembers_ByGroupId' :: Int64 -> ApiEff (Either (ApiError ApplicationError) GroupMemberResponses)
getGroupMembers_ByGroupId' _ByGroupId = handleError <$> getAt [ByGroupId _ByGroupId] ["group_members"]

postGroupMember_ByGlobalGroupId :: forall qp. QueryParam qp => [qp] -> Int64 -> GroupMemberRequest -> ApiEff (Either (ApiError ApplicationError) GroupMemberResponse)
...
postGroupMember_ByGlobalGroupId' :: Int64 -> GroupMemberRequest -> ApiEff (Either (ApiError ApplicationError) GroupMemberResponse)
...
getGroupMember :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) GroupMemberResponse)
getGroupMember params group_member_id = handleError <$> getAt params ["group_member", T.pack $ show group_member_id]

getGroupMember' :: Int64 -> ApiEff (Either (ApiError ApplicationError) GroupMemberResponse)
getGroupMember' group_member_id = handleError <$> getAt ([] :: [(Text, Text)]) ["group_member", T.pack $ show group_member_id]

putGroupMember :: forall qp. QueryParam qp => [qp] -> Int64 -> GroupMemberRequest -> ApiEff (Either (ApiError ApplicationError) GroupMemberResponse)
...
putGroupMember' :: Int64 -> GroupMemberRequest -> ApiEff (Either (ApiError ApplicationError) GroupMemberResponse)
...
deleteGroupMember :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) ())
deleteGroupMember params group_member_id = handleError <$> deleteAt params ["group_member", T.pack $ show group_member_id]

deleteGroupMember' :: Int64 -> ApiEff (Either (ApiError ApplicationError) ())
deleteGroupMember' group_member_id = handleError <$> deleteAt ([] :: [(Text, Text)]) ["group_member", T.pack $ show group_member_id]

getLeurons :: forall qp. QueryParam qp => [qp] -> ApiEff (Either (ApiError ApplicationError) LeuronResponses)
...
postLeuron_ByResourceId :: forall qp. QueryParam qp => [qp] -> Int64 -> LeuronRequest -> ApiEff (Either (ApiError ApplicationError) LeuronResponse)
...
postLeuron_ByResourceId' :: Int64 -> LeuronRequest -> ApiEff (Either (ApiError ApplicationError) LeuronResponse)
postLeuron_ByResourceId' _ByResourceId leuron_request = handleError <$> postAt [ByResourceId _ByResourceId] ["leuron"] leuron_request

getLeuron :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) LeuronResponse)
getLeuron params leuron_id = handleError <$> getAt params ["leuron", T.pack $ show leuron_id]

getLeuron' :: Int64 -> ApiEff (Either (ApiError ApplicationError) LeuronResponse)
getLeuron' leuron_id = handleError <$> getAt ([] :: [(Text, Text)]) ["leuron", T.pack $ show leuron_id]

putLeuron :: forall qp. QueryParam qp => [qp] -> Int64 -> LeuronRequest -> ApiEff (Either (ApiError ApplicationError) LeuronResponse)
putLeuron params leuron_id leuron_request = handleError <$> putAt params ["leuron", T.pack $ show leuron_id] leuron_request

putLeuron' :: Int64 -> LeuronRequest -> ApiEff (Either (ApiError ApplicationError) LeuronResponse)
putLeuron' leuron_id leuron_request = handleError <$> putAt ([] :: [(Text, Text)]) ["leuron", T.pack $ show leuron_id] leuron_request

deleteLeuron :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) ())
deleteLeuron params leuron_id = handleError <$> deleteAt params ["leuron", T.pack $ show leuron_id]

deleteLeuron' :: Int64 -> ApiEff (Either (ApiError ApplicationError) ())
deleteLeuron' leuron_id = handleError <$> deleteAt ([] :: [(Text, Text)]) ["leuron", T.pack $ show leuron_id]

getLikes :: forall qp. QueryParam qp => [qp] -> ApiEff (Either (ApiError ApplicationError) LikeResponses)
...
getLikes_ByThreadPostsIds :: forall qp. QueryParam qp => [qp] -> [Int64] -> ApiEff (Either (ApiError ApplicationError) LikeResponses)
...
getLikes_ByThreadPostsIds' :: [Int64] -> ApiEff (Either (ApiError ApplicationError) LikeResponses)
getLikes_ByThreadPostsIds' _ByThreadPostsIds = handleError <$> getAt [ByThreadPostsIds _ByThreadPostsIds] ["likes"]

getLikes_ByThreadPostId :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) LikeResponses)
...
getLikes_ByThreadPostId' :: Int64 -> ApiEff (Either (ApiError ApplicationError) LikeResponses)
getLikes_ByThreadPostId' _ByThreadPostId = handleError <$> getAt [ByThreadPostId _ByThreadPostId] ["likes"]

getLikes_ByResourceId :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) LikeResponses)
getLikes_ByResourceId params _ByResourceId = handleError <$> getAt (map qp params <> map qp [ByResourceId _ByResourceId]) ["likes"]

getLikes_ByResourceId' :: Int64 -> ApiEff (Either (ApiError ApplicationError) LikeResponses)
getLikes_ByResourceId' _ByResourceId = handleError <$> getAt [ByResourceId _ByResourceId] ["likes"]

postLike_ByThreadPostId :: forall qp. QueryParam qp => [qp] -> Int64 -> LikeRequest -> ApiEff (Either (ApiError ApplicationError) LikeResponse)
...
postLike_ByThreadPostId' :: Int64 -> LikeRequest -> ApiEff (Either (ApiError ApplicationError) LikeResponse)
postLike_ByThreadPostId' _ByThreadPostId like_request = handleError <$> postAt [ByThreadPostId _ByThreadPostId] ["like"] like_request

postLike_ByLeuronId :: forall qp. QueryParam qp => [qp] -> Int64 -> LikeRequest -> ApiEff (Either (ApiError ApplicationError) LikeResponse)
...
postLike_ByLeuronId' :: Int64 -> LikeRequest -> ApiEff (Either (ApiError ApplicationError) LikeResponse)
postLike_ByLeuronId' _ByLeuronId like_request = handleError <$> postAt [ByLeuronId _ByLeuronId] ["like"] like_request

getLike :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) LikeResponse)
getLike params like_id = handleError <$> getAt params ["like", T.pack $ show like_id]

getLike' :: Int64 -> ApiEff (Either (ApiError ApplicationError) LikeResponse)
getLike' like_id = handleError <$> getAt ([] :: [(Text, Text)]) ["like", T.pack $ show like_id]

putLike :: forall qp. QueryParam qp => [qp] -> Int64 -> LikeRequest -> ApiEff (Either (ApiError ApplicationError) LikeResponse)
putLike params like_id like_request = handleError <$> putAt params ["like", T.pack $ show like_id] like_request

putLike' :: Int64 -> LikeRequest -> ApiEff (Either (ApiError ApplicationError) LikeResponse)
putLike' like_id like_request = handleError <$> putAt ([] :: [(Text, Text)]) ["like", T.pack $ show like_id] like_request

deleteLike :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) ())
deleteLike params like_id = handleError <$> deleteAt params ["like", T.pack $ show like_id]

deleteLike' :: Int64 -> ApiEff (Either (ApiError ApplicationError) ())
deleteLike' like_id = handleError <$> deleteAt ([] :: [(Text, Text)]) ["like", T.pack $ show like_id]

getLikeStats_ByThreadPostsIds :: forall qp. QueryParam qp => [qp] -> [Int64] -> ApiEff (Either (ApiError ApplicationError) LikeStatResponses)
...
getLikeStats_ByThreadPostsIds' :: [Int64] -> ApiEff (Either (ApiError ApplicationError) LikeStatResponses)
getLikeStats_ByThreadPostsIds' _ByThreadPostsIds = handleError <$> getAt [ByThreadPostsIds _ByThreadPostsIds] ["like_stats"]

getLikeStat :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) LikeStatResponse)
getLikeStat params like_id = handleError <$> getAt params ["like_stat", T.pack $ show like_id]

getLikeStat' :: Int64 -> ApiEff (Either (ApiError ApplicationError) LikeStatResponse)
getLikeStat' like_id = handleError <$> getAt ([] :: [(Text, Text)]) ["like_stat", T.pack $ show like_id]

getStars :: forall qp. QueryParam qp => [qp] -> ApiEff (Either (ApiError ApplicationError) StarResponses)
...
getStars_ByOrganizationId :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) StarResponses)
...
getStars_ByOrganizationId' :: Int64 -> ApiEff (Either (ApiError ApplicationError) StarResponses)
getStars_ByOrganizationId' _ByOrganizationId = handleError <$> getAt [ByOrganizationId _ByOrganizationId] ["stars"]

getStars_ByUserId :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) StarResponses)
getStars_ByUserId params _ByUserId = handleError <$> getAt (map qp params <> map qp [ByUserId _ByUserId]) ["stars"]

getStars_ByUserId' :: Int64 -> ApiEff (Either (ApiError ApplicationError) StarResponses)
getStars_ByUserId' _ByUserId = handleError <$> getAt [ByUserId _ByUserId] ["stars"]

getStars_ByBoardId :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) StarResponses)
getStars_ByBoardId params _ByBoardId = handleError <$> getAt (map qp params <> map qp [ByBoardId _ByBoardId]) ["stars"]

getStars_ByBoardId' :: Int64 -> ApiEff (Either (ApiError ApplicationError) StarResponses)
getStars_ByBoardId' _ByBoardId = handleError <$> getAt [ByBoardId _ByBoardId] ["stars"]

getStars_ByThreadId :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) StarResponses)
getStars_ByThreadId params _ByThreadId = handleError <$> getAt (map qp params <> map qp [ByThreadId _ByThreadId]) ["stars"]

getStars_ByThreadId' :: Int64 -> ApiEff (Either (ApiError ApplicationError) StarResponses)
getStars_ByThreadId' _ByThreadId = handleError <$> getAt [ByThreadId _ByThreadId] ["stars"]

getStars_ByThreadPostsIds :: forall qp. QueryParam qp => [qp] -> [Int64] -> ApiEff (Either (ApiError ApplicationError) StarResponses)
...
getStars_ByThreadPostsIds' :: [Int64] -> ApiEff (Either (ApiError ApplicationError) StarResponses)
getStars_ByThreadPostsIds' _ByThreadPostsIds = handleError <$> getAt [ByThreadPostsIds _ByThreadPostsIds] ["stars"]

getStars_ByThreadPostId :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) StarResponses)
...
getStars_ByThreadPostId' :: Int64 -> ApiEff (Either (ApiError ApplicationError) StarResponses)
getStars_ByThreadPostId' _ByThreadPostId = handleError <$> getAt [ByThreadPostId _ByThreadPostId] ["stars"]

getStars_ByResourceId :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) StarResponses)
getStars_ByResourceId params _ByResourceId = handleError <$> getAt (map qp params <> map qp [ByResourceId _ByResourceId]) ["stars"]

getStars_ByResourceId' :: Int64 -> ApiEff (Either (ApiError ApplicationError) StarResponses)
getStars_ByResourceId' _ByResourceId = handleError <$> getAt [ByResourceId _ByResourceId] ["stars"]

getStars_ByLeuronId :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) StarResponses)
getStars_ByLeuronId params _ByLeuronId = handleError <$> getAt (map qp params <> map qp [ByLeuronId _ByLeuronId]) ["stars"]

getStars_ByLeuronId' :: Int64 -> ApiEff (Either (ApiError ApplicationError) StarResponses)
getStars_ByLeuronId' _ByLeuronId = handleError <$> getAt [ByLeuronId _ByLeuronId] ["stars"]

postStar_ByOrganizationId :: forall qp. QueryParam qp => [qp] -> Int64 -> StarRequest -> ApiEff (Either (ApiError ApplicationError) StarResponse)
...
postStar_ByOrganizationId' :: Int64 -> StarRequest -> ApiEff (Either (ApiError ApplicationError) StarResponse)
...
postStar_ByUserId :: forall qp. QueryParam qp => [qp] -> Int64 -> StarRequest -> ApiEff (Either (ApiError ApplicationError) StarResponse)
...
postStar_ByUserId' :: Int64 -> StarRequest -> ApiEff (Either (ApiError ApplicationError) StarResponse)
postStar_ByUserId' _ByUserId star_request = handleError <$> postAt [ByUserId _ByUserId] ["star"] star_request

postStar_ByBoardId :: forall qp. QueryParam qp => [qp] -> Int64 -> StarRequest -> ApiEff (Either (ApiError ApplicationError) StarResponse)
...
postStar_ByBoardId' :: Int64 -> StarRequest -> ApiEff (Either (ApiError ApplicationError) StarResponse)
postStar_ByBoardId' _ByBoardId star_request = handleError <$> postAt [ByBoardId _ByBoardId] ["star"] star_request

postStar_ByThreadId :: forall qp. QueryParam qp => [qp] -> Int64 -> StarRequest -> ApiEff (Either (ApiError ApplicationError) StarResponse)
...
postStar_ByThreadId' :: Int64 -> StarRequest -> ApiEff (Either (ApiError ApplicationError) StarResponse)
postStar_ByThreadId' _ByThreadId star_request = handleError <$> postAt [ByThreadId _ByThreadId] ["star"] star_request

postStar_ByThreadPostId :: forall qp. QueryParam qp => [qp] -> Int64 -> StarRequest -> ApiEff (Either (ApiError ApplicationError) StarResponse)
...
postStar_ByThreadPostId' :: Int64 -> StarRequest -> ApiEff (Either (ApiError ApplicationError) StarResponse)
postStar_ByThreadPostId' _ByThreadPostId star_request = handleError <$> postAt [ByThreadPostId _ByThreadPostId] ["star"] star_request

postStar_ByResourceId :: forall qp. QueryParam qp => [qp] -> Int64 -> StarRequest -> ApiEff (Either (ApiError ApplicationError) StarResponse)
...
postStar_ByResourceId' :: Int64 -> StarRequest -> ApiEff (Either (ApiError ApplicationError) StarResponse)
postStar_ByResourceId' _ByResourceId star_request = handleError <$> postAt [ByResourceId _ByResourceId] ["star"] star_request

postStar_ByLeuronId :: forall qp. QueryParam qp => [qp] -> Int64 -> StarRequest -> ApiEff (Either (ApiError ApplicationError) StarResponse)
...
postStar_ByLeuronId' :: Int64 -> StarRequest -> ApiEff (Either (ApiError ApplicationError) StarResponse)
postStar_ByLeuronId' _ByLeuronId star_request = handleError <$> postAt [ByLeuronId _ByLeuronId] ["star"] star_request

getStar :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) StarResponse)
getStar params star_id = handleError <$> getAt params ["star", T.pack $ show star_id]

getStar' :: Int64 -> ApiEff (Either (ApiError ApplicationError) StarResponse)
getStar' star_id = handleError <$> getAt ([] :: [(Text, Text)]) ["star", T.pack $ show star_id]

putStar :: forall qp. QueryParam qp => [qp] -> Int64 -> StarRequest -> ApiEff (Either (ApiError ApplicationError) StarResponse)
putStar params star_id star_request = handleError <$> putAt params ["star", T.pack $ show star_id] star_request

putStar' :: Int64 -> StarRequest -> ApiEff (Either (ApiError ApplicationError) StarResponse)
putStar' star_id star_request = handleError <$> putAt ([] :: [(Text, Text)]) ["star", T.pack $ show star_id] star_request

deleteStar :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) ())
deleteStar params star_id = handleError <$> deleteAt params ["star", T.pack $ show star_id]

deleteStar' :: Int64 -> ApiEff (Either (ApiError ApplicationError) ())
deleteStar' star_id = handleError <$> deleteAt ([] :: [(Text, Text)]) ["star", T.pack $ show star_id]

getStarStats_ByOrganizationId :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) StarStatResponses)
...
getStarStats_ByOrganizationId' :: Int64 -> ApiEff (Either (ApiError ApplicationError) StarStatResponses)
getStarStats_ByOrganizationId' _ByOrganizationId = handleError <$> getAt [ByOrganizationId _ByOrganizationId] ["star_stats"]

getStarStats_ByUserId :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) StarStatResponses)
getStarStats_ByUserId params _ByUserId = handleError <$> getAt (map qp params <> map qp [ByUserId _ByUserId]) ["star_stats"]

getStarStats_ByUserId' :: Int64 -> ApiEff (Either (ApiError ApplicationError) StarStatResponses)
getStarStats_ByUserId' _ByUserId = handleError <$> getAt [ByUserId _ByUserId] ["star_stats"]

getStarStats_ByBoardId :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) StarStatResponses)
getStarStats_ByBoardId params _ByBoardId = handleError <$> getAt (map qp params <> map qp [ByBoardId _ByBoardId]) ["star_stats"]

getStarStats_ByBoardId' :: Int64 -> ApiEff (Either (ApiError ApplicationError) StarStatResponses)
getStarStats_ByBoardId' _ByBoardId = handleError <$> getAt [ByBoardId _ByBoardId] ["star_stats"]

getStarStats_ByThreadId :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) StarStatResponses)
getStarStats_ByThreadId params _ByThreadId = handleError <$> getAt (map qp params <> map qp [ByThreadId _ByThreadId]) ["star_stats"]

getStarStats_ByThreadId' :: Int64 -> ApiEff (Either (ApiError ApplicationError) StarStatResponses)
getStarStats_ByThreadId' _ByThreadId = handleError <$> getAt [ByThreadId _ByThreadId] ["star_stats"]

getStarStats_ByThreadPostsIds :: forall qp. QueryParam qp => [qp] -> [Int64] -> ApiEff (Either (ApiError ApplicationError) StarStatResponses)
...
getStarStats_ByThreadPostsIds' :: [Int64] -> ApiEff (Either (ApiError ApplicationError) StarStatResponses)
getStarStats_ByThreadPostsIds' _ByThreadPostsIds = handleError <$> getAt [ByThreadPostsIds _ByThreadPostsIds] ["star_stats"]

getStarStats_ByThreadPostId :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) StarStatResponses)
...
getStarStats_ByThreadPostId' :: Int64 -> ApiEff (Either (ApiError ApplicationError) StarStatResponses)
getStarStats_ByThreadPostId' _ByThreadPostId = handleError <$> getAt [ByThreadPostId _ByThreadPostId] ["star_stats"]

getStarStats_ByResourceId :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) StarStatResponses)
...
getStarStats_ByResourceId' :: Int64 -> ApiEff (Either (ApiError ApplicationError) StarStatResponses)
getStarStats_ByResourceId' _ByResourceId = handleError <$> getAt [ByResourceId _ByResourceId] ["star_stats"]

getStarStats_ByLeuronId :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) StarStatResponses)
getStarStats_ByLeuronId params _ByLeuronId = handleError <$> getAt (map qp params <> map qp [ByLeuronId _ByLeuronId]) ["star_stats"]

getStarStats_ByLeuronId' :: Int64 -> ApiEff (Either (ApiError ApplicationError) StarStatResponses)
getStarStats_ByLeuronId' _ByLeuronId = handleError <$> getAt [ByLeuronId _ByLeuronId] ["star_stats"]

getStarStat :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) StarStatResponse)
getStarStat params star_id = handleError <$> getAt params ["star_stat", T.pack $ show star_id]

getStarStat' :: Int64 -> ApiEff (Either (ApiError ApplicationError) StarStatResponse)
getStarStat' star_id = handleError <$> getAt ([] :: [(Text, Text)]) ["star_stat", T.pack $ show star_id]

getMe :: forall qp. QueryParam qp => [qp] -> ApiEff (Either (ApiError ApplicationError) UserResponse)
...
getMePack :: forall qp. QueryParam qp => [qp] -> ApiEff (Either (ApiError ApplicationError) UserPackResponse)
...
getOrganizations :: forall qp. QueryParam qp => [qp] -> ApiEff (Either (ApiError ApplicationError) OrganizationResponses)
...
postOrganization :: forall qp. QueryParam qp => [qp] -> OrganizationRequest -> ApiEff (Either (ApiError ApplicationError) OrganizationResponse)
...
getOrganization :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) OrganizationResponse)
getOrganization params organization_id = handleError <$> getAt params ["organization", T.pack $ show organization_id]

getOrganization' :: Int64 -> ApiEff (Either (ApiError ApplicationError) OrganizationResponse)
getOrganization' organization_id = handleError <$> getAt ([] :: [(Text, Text)]) ["organization", T.pack $ show organization_id]

putOrganization :: forall qp. QueryParam qp => [qp] -> Int64 -> OrganizationRequest -> ApiEff (Either (ApiError ApplicationError) OrganizationResponse)
...
putOrganization' :: Int64 -> OrganizationRequest -> ApiEff (Either (ApiError ApplicationError) OrganizationResponse)
...
deleteOrganization :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) ())
deleteOrganization params organization_id = handleError <$> deleteAt params ["organization", T.pack $ show organization_id]

deleteOrganization' :: Int64 -> ApiEff (Either (ApiError ApplicationError) ())
deleteOrganization' organization_id = handleError <$> deleteAt ([] :: [(Text, Text)]) ["organization", T.pack $ show organization_id]

getOrganizationStats :: forall qp. QueryParam qp => [qp] -> ApiEff (Either (ApiError ApplicationError) OrganizationStatResponses)
...
getOrganizationStat :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) OrganizationStatResponse)
getOrganizationStat params organization_id = handleError <$> getAt params ["organization_stat", T.pack $ show organization_id]

getOrganizationStat' :: Int64 -> ApiEff (Either (ApiError ApplicationError) OrganizationStatResponse)
getOrganizationStat' organization_id = handleError <$> getAt ([] :: [(Text, Text)]) ["organization_stat", T.pack $ show organization_id]

getPms :: forall qp. QueryParam qp => [qp] -> ApiEff (Either (ApiError ApplicationError) PmResponses)
...
postPm_ByUsersIds :: forall qp. QueryParam qp => [qp] -> [Int64] -> PmRequest -> ApiEff (Either (ApiError ApplicationError) PmResponse)
...
postPm_ByUsersIds' :: [Int64] -> PmRequest -> ApiEff (Either (ApiError ApplicationError) PmResponse)
postPm_ByUsersIds' _ByUsersIds pm_request = handleError <$> postAt [ByUsersIds _ByUsersIds] ["pm"] pm_request

postPm_ByUserId :: forall qp. QueryParam qp => [qp] -> Int64 -> PmRequest -> ApiEff (Either (ApiError ApplicationError) PmResponse)
postPm_ByUserId params _ByUserId pm_request = handleError <$> postAt (map qp params <> map qp [ByUserId _ByUserId]) ["pm"] pm_request

postPm_ByUserId' :: Int64 -> PmRequest -> ApiEff (Either (ApiError ApplicationError) PmResponse)
postPm_ByUserId' _ByUserId pm_request = handleError <$> postAt [ByUserId _ByUserId] ["pm"] pm_request

getPm :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) PmResponse)
getPm params pm_id = handleError <$> getAt params ["pm", T.pack $ show pm_id]

getPm' :: Int64 -> ApiEff (Either (ApiError ApplicationError) PmResponse)
getPm' pm_id = handleError <$> getAt ([] :: [(Text, Text)]) ["pm", T.pack $ show pm_id]

putPm :: forall qp. QueryParam qp => [qp] -> Int64 -> PmRequest -> ApiEff (Either (ApiError ApplicationError) PmResponse)
putPm params pm_id pm_request = handleError <$> putAt params ["pm", T.pack $ show pm_id] pm_request

putPm' :: Int64 -> PmRequest -> ApiEff (Either (ApiError ApplicationError) PmResponse)
putPm' pm_id pm_request = handleError <$> putAt ([] :: [(Text, Text)]) ["pm", T.pack $ show pm_id] pm_request

deletePm :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) ())
deletePm params pm_id = handleError <$> deleteAt params ["pm", T.pack $ show pm_id]

deletePm' :: Int64 -> ApiEff (Either (ApiError ApplicationError) ())
deletePm' pm_id = handleError <$> deleteAt ([] :: [(Text, Text)]) ["pm", T.pack $ show pm_id]

getPmIns :: forall qp. QueryParam qp => [qp] -> ApiEff (Either (ApiError ApplicationError) PmInResponses)
...
getPmIns_ByUserId :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) PmInResponses)
getPmIns_ByUserId params _ByUserId = handleError <$> getAt (map qp params <> map qp [ByUserId _ByUserId]) ["pm_ins"]

getPmIns_ByUserId' :: Int64 -> ApiEff (Either (ApiError ApplicationError) PmInResponses)
getPmIns_ByUserId' _ByUserId = handleError <$> getAt [ByUserId _ByUserId] ["pm_ins"]

getPmIn :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) PmInResponse)
getPmIn params pm_in_id = handleError <$> getAt params ["pm_in", T.pack $ show pm_in_id]

getPmIn' :: Int64 -> ApiEff (Either (ApiError ApplicationError) PmInResponse)
getPmIn' pm_in_id = handleError <$> getAt ([] :: [(Text, Text)]) ["pm_in", T.pack $ show pm_in_id]

putPmIn :: forall qp. QueryParam qp => [qp] -> Int64 -> PmInRequest -> ApiEff (Either (ApiError ApplicationError) PmInResponse)
putPmIn params pm_in_id pm_in_request = handleError <$> putAt params ["pm_in", T.pack $ show pm_in_id] pm_in_request

putPmIn' :: Int64 -> PmInRequest -> ApiEff (Either (ApiError ApplicationError) PmInResponse)
putPmIn' pm_in_id pm_in_request = handleError <$> putAt ([] :: [(Text, Text)]) ["pm_in", T.pack $ show pm_in_id] pm_in_request

deletePmIn :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) ())
deletePmIn params pm_in_id = handleError <$> deleteAt params ["pm_in", T.pack $ show pm_in_id]

deletePmIn' :: Int64 -> ApiEff (Either (ApiError ApplicationError) ())
deletePmIn' pm_in_id = handleError <$> deleteAt ([] :: [(Text, Text)]) ["pm_in", T.pack $ show pm_in_id]

getPmOuts :: forall qp. QueryParam qp => [qp] -> ApiEff (Either (ApiError ApplicationError) PmOutResponses)
...
getPmOuts_ByUserId :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) PmOutResponses)
getPmOuts_ByUserId params _ByUserId = handleError <$> getAt (map qp params <> map qp [ByUserId _ByUserId]) ["pm_outs"]

getPmOuts_ByUserId' :: Int64 -> ApiEff (Either (ApiError ApplicationError) PmOutResponses)
getPmOuts_ByUserId' _ByUserId = handleError <$> getAt [ByUserId _ByUserId] ["pm_outs"]

getPmOut :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) PmOutResponse)
getPmOut params pm_out_id = handleError <$> getAt params ["pm_out", T.pack $ show pm_out_id]

getPmOut' :: Int64 -> ApiEff (Either (ApiError ApplicationError) PmOutResponse)
getPmOut' pm_out_id = handleError <$> getAt ([] :: [(Text, Text)]) ["pm_out", T.pack $ show pm_out_id]

putPmOut :: forall qp. QueryParam qp => [qp] -> Int64 -> PmOutRequest -> ApiEff (Either (ApiError ApplicationError) PmOutResponse)
putPmOut params pm_out_id pm_out_request = handleError <$> putAt params ["pm_out", T.pack $ show pm_out_id] pm_out_request

putPmOut' :: Int64 -> PmOutRequest -> ApiEff (Either (ApiError ApplicationError) PmOutResponse)
putPmOut' pm_out_id pm_out_request = handleError <$> putAt ([] :: [(Text, Text)]) ["pm_out", T.pack $ show pm_out_id] pm_out_request

deletePmOut :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) ())
deletePmOut params pm_out_id = handleError <$> deleteAt params ["pm_out", T.pack $ show pm_out_id]

deletePmOut' :: Int64 -> ApiEff (Either (ApiError ApplicationError) ())
deletePmOut' pm_out_id = handleError <$> deleteAt ([] :: [(Text, Text)]) ["pm_out", T.pack $ show pm_out_id]

getResources :: forall qp. QueryParam qp => [qp] -> ApiEff (Either (ApiError ApplicationError) ResourceResponses)
...
postResource :: forall qp. QueryParam qp => [qp] -> ResourceRequest -> ApiEff (Either (ApiError ApplicationError) ResourceResponse)
...
getResource :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) ResourceResponse)
getResource params resource_id = handleError <$> getAt params ["resource", T.pack $ show resource_id]

getResource' :: Int64 -> ApiEff (Either (ApiError ApplicationError) ResourceResponse)
getResource' resource_id = handleError <$> getAt ([] :: [(Text, Text)]) ["resource", T.pack $ show resource_id]

putResource :: forall qp. QueryParam qp => [qp] -> Int64 -> ResourceRequest -> ApiEff (Either (ApiError ApplicationError) ResourceResponse)
...
putResource' :: Int64 -> ResourceRequest -> ApiEff (Either (ApiError ApplicationError) ResourceResponse)
putResource' resource_id resource_request = handleError <$> putAt ([] :: [(Text, Text)]) ["resource", T.pack $ show resource_id] resource_request

deleteResource :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) ())
deleteResource params resource_id = handleError <$> deleteAt params ["resource", T.pack $ show resource_id]

deleteResource' :: Int64 -> ApiEff (Either (ApiError ApplicationError) ())
deleteResource' resource_id = handleError <$> deleteAt ([] :: [(Text, Text)]) ["resource", T.pack $ show resource_id]

getResourceStats_ByResourcesIds :: forall qp. QueryParam qp => [qp] -> [Int64] -> ApiEff (Either (ApiError ApplicationError) ResourceStatResponses)
...
getResourceStats_ByResourcesIds' :: [Int64] -> ApiEff (Either (ApiError ApplicationError) ResourceStatResponses)
getResourceStats_ByResourcesIds' _ByResourcesIds = handleError <$> getAt [ByResourcesIds _ByResourcesIds] ["resource_stats"]

getResourceStat :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) ResourceStatResponse)
getResourceStat params resource_id = handleError <$> getAt params ["resource_stat", T.pack $ show resource_id]

getResourceStat' :: Int64 -> ApiEff (Either (ApiError ApplicationError) ResourceStatResponse)
getResourceStat' resource_id = handleError <$> getAt ([] :: [(Text, Text)]) ["resource_stat", T.pack $ show resource_id]

getTeams :: forall qp. QueryParam qp => [qp] -> ApiEff (Either (ApiError ApplicationError) TeamResponses)
...
getTeams_ByOrganizationId :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) TeamResponses)
...
getTeams_ByOrganizationId' :: Int64 -> ApiEff (Either (ApiError ApplicationError) TeamResponses)
getTeams_ByOrganizationId' _ByOrganizationId = handleError <$> getAt [ByOrganizationId _ByOrganizationId] ["teams"]

postTeam_ByOrganizationId :: forall qp. QueryParam qp => [qp] -> Int64 -> TeamRequest -> ApiEff (Either (ApiError ApplicationError) TeamResponse)
...
postTeam_ByOrganizationId' :: Int64 -> TeamRequest -> ApiEff (Either (ApiError ApplicationError) TeamResponse)
...
getTeam :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) TeamResponse)
getTeam params team_id = handleError <$> getAt params ["team", T.pack $ show team_id]

getTeam' :: Int64 -> ApiEff (Either (ApiError ApplicationError) TeamResponse)
getTeam' team_id = handleError <$> getAt ([] :: [(Text, Text)]) ["team", T.pack $ show team_id]

putTeam :: forall qp. QueryParam qp => [qp] -> Int64 -> TeamRequest -> ApiEff (Either (ApiError ApplicationError) TeamResponse)
putTeam params team_id team_request = handleError <$> putAt params ["team", T.pack $ show team_id] team_request

putTeam' :: Int64 -> TeamRequest -> ApiEff (Either (ApiError ApplicationError) TeamResponse)
putTeam' team_id team_request = handleError <$> putAt ([] :: [(Text, Text)]) ["team", T.pack $ show team_id] team_request

deleteTeam :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) ())
deleteTeam params team_id = handleError <$> deleteAt params ["team", T.pack $ show team_id]

deleteTeam' :: Int64 -> ApiEff (Either (ApiError ApplicationError) ())
deleteTeam' team_id = handleError <$> deleteAt ([] :: [(Text, Text)]) ["team", T.pack $ show team_id]

getTeamMembers :: forall qp. QueryParam qp => [qp] -> ApiEff (Either (ApiError ApplicationError) TeamMemberResponses)
...
getTeamMembers_ByOrganizationId :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) TeamMemberResponses)
...
getTeamMembers_ByOrganizationId' :: Int64 -> ApiEff (Either (ApiError ApplicationError) TeamMemberResponses)
getTeamMembers_ByOrganizationId' _ByOrganizationId = handleError <$> getAt [ByOrganizationId _ByOrganizationId] ["team_members"]

getTeamMembers_ByTeamId :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) TeamMemberResponses)
getTeamMembers_ByTeamId params _ByTeamId = handleError <$> getAt (map qp params <> map qp [ByTeamId _ByTeamId]) ["team_members"]

getTeamMembers_ByTeamId' :: Int64 -> ApiEff (Either (ApiError ApplicationError) TeamMemberResponses)
getTeamMembers_ByTeamId' _ByTeamId = handleError <$> getAt [ByTeamId _ByTeamId] ["team_members"]

postTeamMember_ByTeamId :: forall qp. QueryParam qp => [qp] -> Int64 -> TeamMemberRequest -> ApiEff (Either (ApiError ApplicationError) TeamMemberResponse)
...
postTeamMember_ByTeamId' :: Int64 -> TeamMemberRequest -> ApiEff (Either (ApiError ApplicationError) TeamMemberResponse)
...
postTeamMember_ByOrganizationId :: forall qp. QueryParam qp => [qp] -> Int64 -> TeamMemberRequest -> ApiEff (Either (ApiError ApplicationError) TeamMemberResponse)
...
postTeamMember_ByOrganizationId' :: Int64 -> TeamMemberRequest -> ApiEff (Either (ApiError ApplicationError) TeamMemberResponse)
...
getTeamMember :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) TeamMemberResponse)
getTeamMember params team_member_id = handleError <$> getAt params ["team_member", T.pack $ show team_member_id]

getTeamMember' :: Int64 -> ApiEff (Either (ApiError ApplicationError) TeamMemberResponse)
getTeamMember' team_member_id = handleError <$> getAt ([] :: [(Text, Text)]) ["team_member", T.pack $ show team_member_id]

putTeamMember :: forall qp. QueryParam qp => [qp] -> Int64 -> TeamMemberRequest -> ApiEff (Either (ApiError ApplicationError) TeamMemberResponse)
...
putTeamMember' :: Int64 -> TeamMemberRequest -> ApiEff (Either (ApiError ApplicationError) TeamMemberResponse)
...
deleteTeamMember :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) ())
deleteTeamMember params team_member_id = handleError <$> deleteAt params ["team_member", T.pack $ show team_member_id]

deleteTeamMember' :: Int64 -> ApiEff (Either (ApiError ApplicationError) ())
deleteTeamMember' team_member_id = handleError <$> deleteAt ([] :: [(Text, Text)]) ["team_member", T.pack $ show team_member_id]

getThreads :: forall qp. QueryParam qp => [qp] -> ApiEff (Either (ApiError ApplicationError) ThreadResponses)
...
postThread_ByBoardId :: forall qp. QueryParam qp => [qp] -> Int64 -> ThreadRequest -> ApiEff (Either (ApiError ApplicationError) ThreadResponse)
...
postThread_ByBoardId' :: Int64 -> ThreadRequest -> ApiEff (Either (ApiError ApplicationError) ThreadResponse)
postThread_ByBoardId' _ByBoardId thread_request = handleError <$> postAt [ByBoardId _ByBoardId] ["thread"] thread_request

getThread :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) ThreadResponse)
getThread params thread_id = handleError <$> getAt params ["thread", T.pack $ show thread_id]

getThread' :: Int64 -> ApiEff (Either (ApiError ApplicationError) ThreadResponse)
getThread' thread_id = handleError <$> getAt ([] :: [(Text, Text)]) ["thread", T.pack $ show thread_id]

putThread :: forall qp. QueryParam qp => [qp] -> Int64 -> ThreadRequest -> ApiEff (Either (ApiError ApplicationError) ThreadResponse)
putThread params thread_id thread_request = handleError <$> putAt params ["thread", T.pack $ show thread_id] thread_request

putThread' :: Int64 -> ThreadRequest -> ApiEff (Either (ApiError ApplicationError) ThreadResponse)
putThread' thread_id thread_request = handleError <$> putAt ([] :: [(Text, Text)]) ["thread", T.pack $ show thread_id] thread_request

deleteThread :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) ())
deleteThread params thread_id = handleError <$> deleteAt params ["thread", T.pack $ show thread_id]

deleteThread' :: Int64 -> ApiEff (Either (ApiError ApplicationError) ())
deleteThread' thread_id = handleError <$> deleteAt ([] :: [(Text, Text)]) ["thread", T.pack $ show thread_id]

getThreadStats :: forall qp. QueryParam qp => [qp] -> ApiEff (Either (ApiError ApplicationError) ThreadStatResponses)
...
getThreadStat :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) ThreadStatResponse)
getThreadStat params thread_id = handleError <$> getAt params ["thread_stat", T.pack $ show thread_id]

getThreadStat' :: Int64 -> ApiEff (Either (ApiError ApplicationError) ThreadStatResponse)
getThreadStat' thread_id = handleError <$> getAt ([] :: [(Text, Text)]) ["thread_stat", T.pack $ show thread_id]

getThreadPosts :: forall qp. QueryParam qp => [qp] -> ApiEff (Either (ApiError ApplicationError) ThreadPostResponses)
...
getThreadPosts_ByThreadId :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) ThreadPostResponses)
getThreadPosts_ByThreadId params _ByThreadId = handleError <$> getAt (map qp params <> map qp [ByThreadId _ByThreadId]) ["thread_posts"]

getThreadPosts_ByThreadId' :: Int64 -> ApiEff (Either (ApiError ApplicationError) ThreadPostResponses)
getThreadPosts_ByThreadId' _ByThreadId = handleError <$> getAt [ByThreadId _ByThreadId] ["thread_posts"]

postThreadPost_ByThreadId :: forall qp. QueryParam qp => [qp] -> Int64 -> ThreadPostRequest -> ApiEff (Either (ApiError ApplicationError) ThreadPostResponse)
...
postThreadPost_ByThreadId' :: Int64 -> ThreadPostRequest -> ApiEff (Either (ApiError ApplicationError) ThreadPostResponse)
...
getThreadPost :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) ThreadPostResponse)
getThreadPost params thread_post_id = handleError <$> getAt params ["thread_post", T.pack $ show thread_post_id]

getThreadPost' :: Int64 -> ApiEff (Either (ApiError ApplicationError) ThreadPostResponse)
getThreadPost' thread_post_id = handleError <$> getAt ([] :: [(Text, Text)]) ["thread_post", T.pack $ show thread_post_id]

putThreadPost :: forall qp. QueryParam qp => [qp] -> Int64 -> ThreadPostRequest -> ApiEff (Either (ApiError ApplicationError) ThreadPostResponse)
...
putThreadPost' :: Int64 -> ThreadPostRequest -> ApiEff (Either (ApiError ApplicationError) ThreadPostResponse)
...
deleteThreadPost :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) ())
deleteThreadPost params thread_post_id = handleError <$> deleteAt params ["thread_post", T.pack $ show thread_post_id]

deleteThreadPost' :: Int64 -> ApiEff (Either (ApiError ApplicationError) ())
deleteThreadPost' thread_post_id = handleError <$> deleteAt ([] :: [(Text, Text)]) ["thread_post", T.pack $ show thread_post_id]

getThreadPostStats_ByThreadPostsIds :: forall qp. QueryParam qp => [qp] -> [Int64] -> ApiEff (Either (ApiError ApplicationError) ThreadPostStatResponses)
...
getThreadPostStats_ByThreadPostsIds' :: [Int64] -> ApiEff (Either (ApiError ApplicationError) ThreadPostStatResponses)
...
getThreadPostStat :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) ThreadPostStatResponse)
getThreadPostStat params thread_post_id = handleError <$> getAt params ["thread_post_stat", T.pack $ show thread_post_id]

getThreadPostStat' :: Int64 -> ApiEff (Either (ApiError ApplicationError) ThreadPostStatResponse)
...
getUserProfiles :: forall qp. QueryParam qp => [qp] -> ApiEff (Either (ApiError ApplicationError) ProfileResponses)
...
getUserProfiles_ByUserId :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) ProfileResponses)
getUserProfiles_ByUserId params _ByUserId = handleError <$> getAt (map qp params <> map qp [ByUserId _ByUserId]) ["user_profiles"]

getUserProfiles_ByUserId' :: Int64 -> ApiEff (Either (ApiError ApplicationError) ProfileResponses)
getUserProfiles_ByUserId' _ByUserId = handleError <$> getAt [ByUserId _ByUserId] ["user_profiles"]

getUserProfiles_ByUsersIds :: forall qp. QueryParam qp => [qp] -> [Int64] -> ApiEff (Either (ApiError ApplicationError) ProfileResponses)
...
getUserProfiles_ByUsersIds' :: [Int64] -> ApiEff (Either (ApiError ApplicationError) ProfileResponses)
getUserProfiles_ByUsersIds' _ByUsersIds = handleError <$> getAt [ByUsersIds _ByUsersIds] ["user_profiles"]

getUserProfile :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) ProfileResponse)
getUserProfile params profile_id = handleError <$> getAt params ["user_profile", T.pack $ show profile_id]

getUserProfile' :: Int64 -> ApiEff (Either (ApiError ApplicationError) ProfileResponse)
getUserProfile' profile_id = handleError <$> getAt ([] :: [(Text, Text)]) ["user_profile", T.pack $ show profile_id]

putUserProfile :: forall qp. QueryParam qp => [qp] -> Int64 -> ProfileRequest -> ApiEff (Either (ApiError ApplicationError) ProfileResponse)
...
putUserProfile' :: Int64 -> ProfileRequest -> ApiEff (Either (ApiError ApplicationError) ProfileResponse)
...
deleteUserProfile :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) ())
deleteUserProfile params profile_id = handleError <$> deleteAt params ["user_profile", T.pack $ show profile_id]

deleteUserProfile' :: Int64 -> ApiEff (Either (ApiError ApplicationError) ())
deleteUserProfile' profile_id = handleError <$> deleteAt ([] :: [(Text, Text)]) ["user_profile", T.pack $ show profile_id]

getUsersSanitized :: forall qp. QueryParam qp => [qp] -> ApiEff (Either (ApiError ApplicationError) UserSanitizedResponses)
...
getUsersSanitized_ByUsersIds :: forall qp. QueryParam qp => [qp] -> [Int64] -> ApiEff (Either (ApiError ApplicationError) UserSanitizedResponses)
...
getUserSanitized' :: Int64 -> ApiEff (Either (ApiError ApplicationError) UserSanitizedResponse)
getUserSanitized' user_id = handleError <$> getAt ([] :: [(Text, Text)]) ["user_sanitized", T.pack $ show user_id]

getUserSanitizedStats :: forall qp. QueryParam qp => [qp] -> ApiEff (Either (ApiError ApplicationError) UserSanitizedStatResponse)
...
getUserSanitizedStats_ByUsersIds :: forall qp. QueryParam qp => [qp] -> [Int64] -> ApiEff (Either (ApiError ApplicationError) UserSanitizedStatResponse)
...
getUserSanitizedStats_ByUsersIds' :: [Int64] -> ApiEff (Either (ApiError ApplicationError) UserSanitizedStatResponse)
getUserSanitizedStats_ByUsersIds' _ByUsersIds = handleError <$> getAt [ByUsersIds _ByUsersIds] ["user_sanitized_stats"]

getUserSanitizedStat :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) UserSanitizedStatResponse)
getUserSanitizedStat params user_id = handleError <$> getAt params ["user_sanitized_stat", T.pack $ show user_id]

getUserSanitizedStat' :: Int64 -> ApiEff (Either (ApiError ApplicationError) UserSanitizedStatResponse)
getUserSanitizedStat' user_id = handleError <$> getAt ([] :: [(Text, Text)]) ["user_sanitized_stat", T.pack $ show user_id]

getOrganizationPacks :: forall qp. QueryParam qp => [qp] -> ApiEff (Either (ApiError ApplicationError) OrganizationPackResponses)
...
getOrganizationPacks_ByOrganizationsIds :: forall qp. QueryParam qp => [qp] -> [Int64] -> ApiEff (Either (ApiError ApplicationError) OrganizationPackResponses)
...
getOrganizationPacks_ByOrganizationsIds' :: [Int64] -> ApiEff (Either (ApiError ApplicationError) OrganizationPackResponses)
...
getOrganizationPack :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) OrganizationPackResponse)
getOrganizationPack params organization_id = handleError <$> getAt params ["organization_pack", T.pack $ show organization_id]

getOrganizationPack' :: Int64 -> ApiEff (Either (ApiError ApplicationError) OrganizationPackResponse)
getOrganizationPack' organization_id = handleError <$> getAt ([] :: [(Text, Text)]) ["organization_pack", T.pack $ show organization_id]

getTeamPacks :: forall qp. QueryParam qp => [qp] -> ApiEff (Either (ApiError ApplicationError) TeamPackResponses)
...
getTeamPacks_ByOrganizationId :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) TeamPackResponses)
...
getTeamPacks_ByOrganizationId' :: Int64 -> ApiEff (Either (ApiError ApplicationError) TeamPackResponses)
getTeamPacks_ByOrganizationId' _ByOrganizationId = handleError <$> getAt [ByOrganizationId _ByOrganizationId] ["team_packs"]

getTeamPack :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) TeamPackResponse)
getTeamPack params team_id = handleError <$> getAt params ["team_pack", T.pack $ show team_id]

getTeamPack' :: Int64 -> ApiEff (Either (ApiError ApplicationError) TeamPackResponse)
getTeamPack' team_id = handleError <$> getAt ([] :: [(Text, Text)]) ["team_pack", T.pack $ show team_id]

getTeamMemberPacks :: forall qp. QueryParam qp => [qp] -> ApiEff (Either (ApiError ApplicationError) TeamMemberPackResponses)
...
getTeamMemberPacks_ByOrganizationId :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) TeamMemberPackResponses)
...
getTeamMemberPacks_ByOrganizationId' :: Int64 -> ApiEff (Either (ApiError ApplicationError) TeamMemberPackResponses)
...
getTeamMemberPacks_ByTeamId :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) TeamMemberPackResponses)
getTeamMemberPacks_ByTeamId params _ByTeamId = handleError <$> getAt (map qp params <> map qp [ByTeamId _ByTeamId]) ["team_member_packs"]

getTeamMemberPacks_ByTeamId' :: Int64 -> ApiEff (Either (ApiError ApplicationError) TeamMemberPackResponses)
getTeamMemberPacks_ByTeamId' _ByTeamId = handleError <$> getAt [ByTeamId _ByTeamId] ["team_member_packs"]

getTeamMemberPack :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) TeamMemberPackResponse)
getTeamMemberPack params team_member_id = handleError <$> getAt params ["team_member_pack", T.pack $ show team_member_id]

getTeamMemberPack' :: Int64 -> ApiEff (Either (ApiError ApplicationError) TeamMemberPackResponse)
getTeamMemberPack' team_member_id = handleError <$> getAt ([] :: [(Text, Text)]) ["team_member_pack", T.pack $ show team_member_id]

getUserPacks :: forall qp. QueryParam qp => [qp] -> ApiEff (Either (ApiError ApplicationError) UserPackResponses)
...
getUserPacks_ByUsersIds :: forall qp. QueryParam qp => [qp] -> [Int64] -> ApiEff (Either (ApiError ApplicationError) UserPackResponses)
getUserPacks_ByUsersIds params _ByUsersIds = handleError <$> getAt (map qp params <> map qp [ByUsersIds _ByUsersIds]) ["user_packs"]

getUserPacks_ByUsersIds' :: [Int64] -> ApiEff (Either (ApiError ApplicationError) UserPackResponses)
getUserPacks_ByUsersIds' _ByUsersIds = handleError <$> getAt [ByUsersIds _ByUsersIds] ["user_packs"]

getUserPack :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) UserPackResponse)
getUserPack params user_id = handleError <$> getAt params ["user_pack", T.pack $ show user_id]

getUserPack' :: Int64 -> ApiEff (Either (ApiError ApplicationError) UserPackResponse)
getUserPack' user_id = handleError <$> getAt ([] :: [(Text, Text)]) ["user_pack", T.pack $ show user_id]

getUserSanitizedPacks :: forall qp. QueryParam qp => [qp] -> ApiEff (Either (ApiError ApplicationError) UserSanitizedPackResponses)
...
getUserSanitizedPacks_ByUsersIds :: forall qp. QueryParam qp => [qp] -> [Int64] -> ApiEff (Either (ApiError ApplicationError) UserSanitizedPackResponses)
...
getUserSanitizedPacks_ByUsersIds' :: [Int64] -> ApiEff (Either (ApiError ApplicationError) UserSanitizedPackResponses)
getUserSanitizedPacks_ByUsersIds' _ByUsersIds = handleError <$> getAt [ByUsersIds _ByUsersIds] ["user_sanitized_packs"]

getUserSanitizedPack :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) UserSanitizedPackResponse)
getUserSanitizedPack params user_id = handleError <$> getAt params ["user_sanitized_pack", T.pack $ show user_id]

getUserSanitizedPack' :: Int64 -> ApiEff (Either (ApiError ApplicationError) UserSanitizedPackResponse)
getUserSanitizedPack' user_id = handleError <$> getAt ([] :: [(Text, Text)]) ["user_sanitized_pack", T.pack $ show user_id]

getGlobalGroupPacks :: forall qp. QueryParam qp => [qp] -> ApiEff (Either (ApiError ApplicationError) GlobalGroupPackResponses)
...
getGlobalGroupPacks_ByOrganizationId :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) GlobalGroupPackResponses)
...
getGlobalGroupPacks_ByOrganizationId' :: Int64 -> ApiEff (Either (ApiError ApplicationError) GlobalGroupPackResponses)
...
getGlobalGroupPack :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) GlobalGroupPackResponse)
getGlobalGroupPack params global_group_id = handleError <$> getAt params ["global_group_pack", T.pack $ show global_group_id]

getGlobalGroupPack' :: Int64 -> ApiEff (Either (ApiError ApplicationError) GlobalGroupPackResponse)
getGlobalGroupPack' global_group_id = handleError <$> getAt ([] :: [(Text, Text)]) ["global_group_pack", T.pack $ show global_group_id]

getGroupPacks :: forall qp. QueryParam qp => [qp] -> ApiEff (Either (ApiError ApplicationError) GroupPackResponses)
...
getGroupPacks_ByOrganizationId :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) GroupPackResponses)
...
getGroupPacks_ByOrganizationId' :: Int64 -> ApiEff (Either (ApiError ApplicationError) GroupPackResponses)
getGroupPacks_ByOrganizationId' _ByOrganizationId = handleError <$> getAt [ByOrganizationId _ByOrganizationId] ["group_packs"]

getGroupPack :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) GroupPackResponse)
getGroupPack params group_id = handleError <$> getAt params ["group_pack", T.pack $ show group_id]

getGroupPack' :: Int64 -> ApiEff (Either (ApiError ApplicationError) GroupPackResponse)
getGroupPack' group_id = handleError <$> getAt ([] :: [(Text, Text)]) ["group_pack", T.pack $ show group_id]

getGroupMemberPacks :: forall qp. QueryParam qp => [qp] -> ApiEff (Either (ApiError ApplicationError) GroupMemberPackResponses)
...
getGroupMemberPacks_ByOrganizationId :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) GroupMemberPackResponses)
...
getGroupMemberPacks_ByOrganizationId' :: Int64 -> ApiEff (Either (ApiError ApplicationError) GroupMemberPackResponses)
...
getGroupMemberPacks_ByGlobalGroupId :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) GroupMemberPackResponses)
...
getGroupMemberPacks_ByGlobalGroupId' :: Int64 -> ApiEff (Either (ApiError ApplicationError) GroupMemberPackResponses)
...
getGroupMemberPacks_ByGroupId :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) GroupMemberPackResponses)
...
getGroupMemberPacks_ByGroupId' :: Int64 -> ApiEff (Either (ApiError ApplicationError) GroupMemberPackResponses)
getGroupMemberPacks_ByGroupId' _ByGroupId = handleError <$> getAt [ByGroupId _ByGroupId] ["group_member_packs"]

getGroupMemberPack :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) GroupMemberPackResponse)
getGroupMemberPack params group_member_id = handleError <$> getAt params ["group_member_pack", T.pack $ show group_member_id]

getGroupMemberPack' :: Int64 -> ApiEff (Either (ApiError ApplicationError) GroupMemberPackResponse)
getGroupMemberPack' group_member_id = handleError <$> getAt ([] :: [(Text, Text)]) ["group_member_pack", T.pack $ show group_member_id]

getForumPacks :: forall qp. QueryParam qp => [qp] -> ApiEff (Either (ApiError ApplicationError) ForumPackResponses)
...
getForumPacks_ByForumId :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) ForumPackResponses)
getForumPacks_ByForumId params _ByForumId = handleError <$> getAt (map qp params <> map qp [ByForumId _ByForumId]) ["forum_packs"]

getForumPacks_ByForumId' :: Int64 -> ApiEff (Either (ApiError ApplicationError) ForumPackResponses)
getForumPacks_ByForumId' _ByForumId = handleError <$> getAt [ByForumId _ByForumId] ["forum_packs"]

getForumPacks_ByForumsIds :: forall qp. QueryParam qp => [qp] -> [Int64] -> ApiEff (Either (ApiError ApplicationError) ForumPackResponses)
...
getForumPacks_ByForumsIds' :: [Int64] -> ApiEff (Either (ApiError ApplicationError) ForumPackResponses)
getForumPacks_ByForumsIds' _ByForumsIds = handleError <$> getAt [ByForumsIds _ByForumsIds] ["forum_packs"]

getForumPacks_ByOrganizationId :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) ForumPackResponses)
...
getForumPacks_ByOrganizationId' :: Int64 -> ApiEff (Either (ApiError ApplicationError) ForumPackResponses)
getForumPacks_ByOrganizationId' _ByOrganizationId = handleError <$> getAt [ByOrganizationId _ByOrganizationId] ["forum_packs"]

getForumPacks_ByOrganizationName :: forall qp. QueryParam qp => [qp] -> Text -> ApiEff (Either (ApiError ApplicationError) ForumPackResponses)
...
getForumPacks_ByOrganizationName' :: Text -> ApiEff (Either (ApiError ApplicationError) ForumPackResponses)
...
getForumPack :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) ForumPackResponse)
getForumPack params forum_id = handleError <$> getAt params ["forum_pack", T.pack $ show forum_id]

getForumPack' :: Int64 -> ApiEff (Either (ApiError ApplicationError) ForumPackResponse)
getForumPack' forum_id = handleError <$> getAt ([] :: [(Text, Text)]) ["forum_pack", T.pack $ show forum_id]

getBoardPacks :: forall qp. QueryParam qp => [qp] -> ApiEff (Either (ApiError ApplicationError) BoardPackResponses)
...
getBoardPacks_ByForumId :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) BoardPackResponses)
getBoardPacks_ByForumId params _ByForumId = handleError <$> getAt (map qp params <> map qp [ByForumId _ByForumId]) ["board_packs"]

getBoardPacks_ByForumId' :: Int64 -> ApiEff (Either (ApiError ApplicationError) BoardPackResponses)
getBoardPacks_ByForumId' _ByForumId = handleError <$> getAt [ByForumId _ByForumId] ["board_packs"]

getBoardPacks_ByBoardsIds :: forall qp. QueryParam qp => [qp] -> [Int64] -> ApiEff (Either (ApiError ApplicationError) BoardPackResponses)
...
getBoardPacks_ByBoardsIds' :: [Int64] -> ApiEff (Either (ApiError ApplicationError) BoardPackResponses)
getBoardPacks_ByBoardsIds' _ByBoardsIds = handleError <$> getAt [ByBoardsIds _ByBoardsIds] ["board_packs"]

getBoardPacks_ByBoardId :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) BoardPackResponses)
getBoardPacks_ByBoardId params _ByBoardId = handleError <$> getAt (map qp params <> map qp [ByBoardId _ByBoardId]) ["board_packs"]

getBoardPacks_ByBoardId' :: Int64 -> ApiEff (Either (ApiError ApplicationError) BoardPackResponses)
getBoardPacks_ByBoardId' _ByBoardId = handleError <$> getAt [ByBoardId _ByBoardId] ["board_packs"]

getBoardPack :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) BoardPackResponse)
getBoardPack params board_id = handleError <$> getAt params ["board_pack", T.pack $ show board_id]

getBoardPack' :: Int64 -> ApiEff (Either (ApiError ApplicationError) BoardPackResponse)
getBoardPack' board_id = handleError <$> getAt ([] :: [(Text, Text)]) ["board_pack", T.pack $ show board_id]

getThreadPacks :: forall qp. QueryParam qp => [qp] -> ApiEff (Either (ApiError ApplicationError) ThreadPackResponses)
...
getThreadPacks_ByThreadsIds :: forall qp. QueryParam qp => [qp] -> [Int64] -> ApiEff (Either (ApiError ApplicationError) ThreadPackResponses)
...
getThreadPacks_ByThreadsIds' :: [Int64] -> ApiEff (Either (ApiError ApplicationError) ThreadPackResponses)
getThreadPacks_ByThreadsIds' _ByThreadsIds = handleError <$> getAt [ByThreadsIds _ByThreadsIds] ["thread_packs"]

getThreadPacks_ByForumId :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) ThreadPackResponses)
getThreadPacks_ByForumId params _ByForumId = handleError <$> getAt (map qp params <> map qp [ByForumId _ByForumId]) ["thread_packs"]

getThreadPacks_ByForumId' :: Int64 -> ApiEff (Either (ApiError ApplicationError) ThreadPackResponses)
getThreadPacks_ByForumId' _ByForumId = handleError <$> getAt [ByForumId _ByForumId] ["thread_packs"]

getThreadPacks_ByBoardId :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) ThreadPackResponses)
getThreadPacks_ByBoardId params _ByBoardId = handleError <$> getAt (map qp params <> map qp [ByBoardId _ByBoardId]) ["thread_packs"]

getThreadPacks_ByBoardId' :: Int64 -> ApiEff (Either (ApiError ApplicationError) ThreadPackResponses)
getThreadPacks_ByBoardId' _ByBoardId = handleError <$> getAt [ByBoardId _ByBoardId] ["thread_packs"]

getThreadPack :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) ThreadPackResponse)
getThreadPack params thread_id = handleError <$> getAt params ["thread_pack", T.pack $ show thread_id]

getThreadPack' :: Int64 -> ApiEff (Either (ApiError ApplicationError) ThreadPackResponse)
getThreadPack' thread_id = handleError <$> getAt ([] :: [(Text, Text)]) ["thread_pack", T.pack $ show thread_id]

getThreadPostPacks :: forall qp. QueryParam qp => [qp] -> ApiEff (Either (ApiError ApplicationError) ThreadPostPackResponses)
...
getThreadPostPacks_ByThreadPostsIds :: forall qp. QueryParam qp => [qp] -> [Int64] -> ApiEff (Either (ApiError ApplicationError) ThreadPostPackResponses)
...
getThreadPostPacks_ByThreadPostsIds' :: [Int64] -> ApiEff (Either (ApiError ApplicationError) ThreadPostPackResponses)
...
getThreadPostPacks_ByThreadId :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) ThreadPostPackResponses)
...
getThreadPostPacks_ByThreadId' :: Int64 -> ApiEff (Either (ApiError ApplicationError) ThreadPostPackResponses)
getThreadPostPacks_ByThreadId' _ByThreadId = handleError <$> getAt [ByThreadId _ByThreadId] ["thread_post_packs"]

getThreadPostPacks_ByForumId :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) ThreadPostPackResponses)
...
getThreadPostPacks_ByForumId' :: Int64 -> ApiEff (Either (ApiError ApplicationError) ThreadPostPackResponses)
getThreadPostPacks_ByForumId' _ByForumId = handleError <$> getAt [ByForumId _ByForumId] ["thread_post_packs"]

getThreadPostPacks_ByBoardId :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) ThreadPostPackResponses)
...
getThreadPostPacks_ByBoardId' :: Int64 -> ApiEff (Either (ApiError ApplicationError) ThreadPostPackResponses)
getThreadPostPacks_ByBoardId' _ByBoardId = handleError <$> getAt [ByBoardId _ByBoardId] ["thread_post_packs"]

getThreadPostPack :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) ThreadPostPackResponse)
getThreadPostPack params thread_post_id = handleError <$> getAt params ["thread_post_pack", T.pack $ show thread_post_id]

getThreadPostPack' :: Int64 -> ApiEff (Either (ApiError ApplicationError) ThreadPostPackResponse)
getThreadPostPack' thread_post_id = handleError <$> getAt ([] :: [(Text, Text)]) ["thread_post_pack", T.pack $ show thread_post_id]

getResourcePacks :: forall qp. QueryParam qp => [qp] -> ApiEff (Either (ApiError ApplicationError) ResourcePackResponses)
...
getResourcePacks_ByResourcesIds :: forall qp. QueryParam qp => [qp] -> [Int64] -> ApiEff (Either (ApiError ApplicationError) ResourcePackResponses)
...
getResourcePacks_ByResourcesIds' :: [Int64] -> ApiEff (Either (ApiError ApplicationError) ResourcePackResponses)
getResourcePacks_ByResourcesIds' _ByResourcesIds = handleError <$> getAt [ByResourcesIds _ByResourcesIds] ["resource_packs"]

getResourcePack :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) ResourcePackResponse)
getResourcePack params resource_id = handleError <$> getAt params ["resource_pack", T.pack $ show resource_id]

getResourcePack' :: Int64 -> ApiEff (Either (ApiError ApplicationError) ResourcePackResponse)
getResourcePack' resource_id = handleError <$> getAt ([] :: [(Text, Text)]) ["resource_pack", T.pack $ show resource_id]

getLeuronPacks :: forall qp. QueryParam qp => [qp] -> ApiEff (Either (ApiError ApplicationError) LeuronPackResponses)
...
getLeuronPacks_ByLeuronsIds :: forall qp. QueryParam qp => [qp] -> [Int64] -> ApiEff (Either (ApiError ApplicationError) LeuronPackResponses)
...
getLeuronPacks_ByLeuronsIds' :: [Int64] -> ApiEff (Either (ApiError ApplicationError) LeuronPackResponses)
getLeuronPacks_ByLeuronsIds' _ByLeuronsIds = handleError <$> getAt [ByLeuronsIds _ByLeuronsIds] ["leuron_packs"]

getLeuronPacks_ByResourceId :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) LeuronPackResponses)
...
getLeuronPacks_ByResourceId' :: Int64 -> ApiEff (Either (ApiError ApplicationError) LeuronPackResponses)
getLeuronPacks_ByResourceId' _ByResourceId = handleError <$> getAt [ByResourceId _ByResourceId] ["leuron_packs"]

getLeuronPack :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) LeuronPackResponse)
getLeuronPack params leuron_id = handleError <$> getAt params ["leuron_pack", T.pack $ show leuron_id]

getLeuronPack' :: Int64 -> ApiEff (Either (ApiError ApplicationError) LeuronPackResponse)
getLeuronPack' leuron_id = handleError <$> getAt ([] :: [(Text, Text)]) ["leuron_pack", T.pack $ show leuron_id]

getPmInPacks :: forall qp. QueryParam qp => [qp] -> ApiEff (Either (ApiError ApplicationError) LeuronPackResponses)
...
getPmInPack :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) PmInPackResponse)
getPmInPack params pm_in_id = handleError <$> getAt params ["pm_in_pack", T.pack $ show pm_in_id]

getPmInPack' :: Int64 -> ApiEff (Either (ApiError ApplicationError) PmInPackResponse)
getPmInPack' pm_in_id = handleError <$> getAt ([] :: [(Text, Text)]) ["pm_in_pack", T.pack $ show pm_in_id]

getPmOutPacks :: forall qp. QueryParam qp => [qp] -> ApiEff (Either (ApiError ApplicationError) LeuronPackResponses)
...
getPmOutPack :: forall qp. QueryParam qp => [qp] -> Int64 -> ApiEff (Either (ApiError ApplicationError) PmOutPackResponse)
getPmOutPack params pm_out_id = handleError <$> getAt params ["pm_out_pack", T.pack $ show pm_out_id]

getPmOutPack' :: Int64 -> ApiEff (Either (ApiError ApplicationError) PmOutPackResponse)
